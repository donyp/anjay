...
const menu = `*Hallo @${sender.split("@")[0]} 🙌*
╔┈「 INFO USER 」
╎❒ ɴᴀᴍᴀ: ${pushname}
...
╚┈┈┈┈┈┈┈┈┈┈┈┈
╔┈「 Donn Botz 」
╎${prefix}1gb *nama,number*
╎${prefix}2gb *nama,number*
╎${prefix}3gb *nama,number*
╎${prefix}4gb *nama,number*
╎${prefix}5gb *nama,number*
╎${prefix}6gb *nama,number*
╎${prefix}7gb *nama,number*
╎${prefix}8gb *nama,number*
╎${prefix}9gb *nama,number*
╎${prefix}10gb *nama,number*
╎${prefix}unli *nama,number*
╚┈┈┈┈┈┈┈┈┈┈┈┈
╔┈「 PT Donn 」
╎${prefix}toadmin
╎${prefix}listadmin
...
break
case "unli": {
    if (!isOwner) return reply(`ini khusus zylen🔥`)
let t = text.split(',');
if (t.length < 2) return m.reply(`*Format salah!*
Penggunaan:
${prefix + command} user,nomer`)
